<?php
    ...
    if (!isset($_POST['submit'])) { //if not
        ...
        header ("location: editproductform.php?status=not_submitted");
        exit;
    }
    ...
    if (isset($_POST["product_id"])) {
        ...
        header ("location: editproductform.php?status=not_submited");
        exit;
    }
    ...
    if ($result == false) {
        header("Location: editproductform.php?status=invalid_input");
        exit;
    }
    ...
    //if database connection is set
        ...
        if ($result) { //execute query successfully
            header("Location: editproductform.php?status=success");
        }
        else {
            header("Location: editproductform.php?status=database_error");
        }
